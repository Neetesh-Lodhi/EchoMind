...
function Customize() {
 ...
 const navigate = useNavigate()
  ...
  const handleImage = (e) => {
    ...
    setFrontendImage(URL.createObjectURL(file)); //convert into url
  };
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] ">
      <h1 className="text-white text-[30px] font-bond text-center mb-[30px]">
        Select Your <span className="text-blue-200">Assistent Image</span>
      </h1>
